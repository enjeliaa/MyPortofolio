const Projects = () => {
  const portfolioItems = [
    { 
      ...
      desc: "Aplikasi web full-stack untuk rating dan ulasan produk. Dilengkapi Admin Dashboard untuk manajemen data user.",
      // Ganti nama file di bawah sesuai nama file gambarmu di folder public/images
      image: "/image/fullstack.jpg", 
      // Jika ada link GitHub/Demo, isi di sini. Jika tidak, biarkan "#"
    ...
    { 
      ...
      desc: "Optimasi performa server dengan Load Balancing dan manajemen keamanan jarak jauh menggunakan SSH.",
    ...
    { 
      ...
      tech: ["Python", "Pandas"], 
      desc: "Analisis dataset besar untuk menemukan pola tren bisnis menggunakan algoritma data mining.",
    ...
    <section id="projects" className="py-24 bg-slate-900">
      <div className="max-w-screen-xl mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-extrabold tracking-tight text-white mb-4">Project Akademik</h2>
          <p className="text-gray-400">Bukti nyata hasil pengerjaan studi kasus teknis.</p>
        </div>
            ...
            <div key={index} className="group bg-slate-800 border border-slate-700 rounded-xl overflow-hidden shadow-lg hover:shadow-blue-500/10 transition-all duration-300 hover:-translate-y-2 flex flex-col">
              ...
              <div className="relative overflow-hidden h-48 w-full bg-slate-700">
                <img 
                  ...
                  // Ini script cadangan: kalau gambar belum ada, dia akan menampilkan kotak abu-abu
                  onError={(e) => {
